import { GoodsDetail, GoodsPageResult, GoodsQueryParam } from '@/types/api/pms/goods'
 ...
 * @param queryParams
 */
export function listSpuPages(queryParams: GoodsQueryParam): AxiosPromise<GoodsPageResult> {
  return request({
